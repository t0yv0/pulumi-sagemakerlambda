...
{
    [SagemakerlambdaResourceType("sagemakerlambda:index:StaticPage")]
    public partial class StaticPage : Pulumi.ComponentResource
    {
        ...
        public StaticPage(string name, StaticPageArgs args, ComponentResourceOptions? options = null)
            : base("sagemakerlambda:index:StaticPage", name, args ?? new StaticPageArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
