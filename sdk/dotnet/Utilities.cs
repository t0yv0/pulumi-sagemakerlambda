...
namespace Pulumi.Sagemakerlambda
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Sagemakerlambda.version.txt");
    ...
    internal sealed class SagemakerlambdaResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public SagemakerlambdaResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
